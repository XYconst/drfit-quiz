...
export const STEPS: StepSpec[] = [
  ...
  },
  {
    ...
    bodyBg: 'Dr.Fit е в джоба ти всеки ден. Тренировки за 30 минути у дома, седмични менюта, напомняния, и AI-асистент, който отговаря на твоите въпроси по всяко време.',
    ctaBg: 'Продължи',
