...
export const STEPS: StepSpec[] = [
  ...
  },
  {
    ...
    id: 'building-3',
    type: 'interstitial',
    headline: 'Личният ти треньор в джоба',
    bodyBg: '„Не вярвах, че е възможно без личен треньор" — Иван свали 14 кг за 4 месеца с Dr.Fit, по 30 минути на ден у дома. Десетки хиляди свалиха приложението от 2024.',
    ctaBg: 'Продължи',
